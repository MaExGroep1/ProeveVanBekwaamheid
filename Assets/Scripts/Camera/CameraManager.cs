...
namespace CustomCamera
{
    ...
    { 
        ...
        [SerializeField] private Vector3 targetOffset = new (1.5f, 0.5f, -1f); // The offset of the camera's target
        ...
        {
            cameraTransform.LookAt(carTransform.position + targetOffset);
        }
